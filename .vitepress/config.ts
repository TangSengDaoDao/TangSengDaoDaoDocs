...
export default defineConfig({
	...
	themeConfig: {
		...
		footer: {
			...
			copyright:
				"Copyright © 2023 | Powered by 唐僧叨叨 | <a href='https://beian.miit.gov.cn/' target='_blank'>沪ICP备2021032718号-3</a> | <a href='https://beian.miit.gov.cn/' target='_blank'>沪ICP备2021032718号-4</a>",
		},
		search: {
			provider: "local",
			options: {
